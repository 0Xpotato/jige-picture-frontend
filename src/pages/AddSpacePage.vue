<template>
  <div id="addSpacePage">
    ...
    <!-- 空间信息表单 -->
    <a-form :model="spaceForm" layout="vertical" name="spaceForm" @finish="handleSubmit">
      <a-form-item label="空间名称" name="spaceName">
        <a-input v-model:value="spaceForm.spaceName" allow-clear placeholder="请输入空间" />
      </a-form-item>
...
import {
  addSpaceUsingPost,
  getSpaceVoByIdUsingGet, listSpaceLevelUsingPost,
