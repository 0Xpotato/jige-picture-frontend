<template>
  ...
  >
    <a-row gutter="16">
      <a-col span="12">
        <h4>原始图片</h4>
        <img :alt="picture?.name" :src="picture?.url" style="max-width: 100%" />
      </a-col>
      <a-col span="12">
        <h4>扩图结果</h4>
        <img
    ...
    <a-flex gap="16" justify="center">
      <a-button :loading="!!taskId" ghost type="primary" @click="createTask">生成图片</a-button>
